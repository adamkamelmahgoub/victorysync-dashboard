              ...
              {mode === "signin" && (
                <div className="mt-6 space-y-4">
                  ...
                  <button type="button" onClick={handleGoogleSignIn}
                    className={`flex w-full items-center justify-center gap-3 rounded-xl border px-4 py-3 text-sm font-semibold transition hover:opacity-80 ${isLight_ ? "border-slate-200 bg-white text-slate-700" : "border-white/[0.08] bg-white/[0.04] text-slate-200"}`}>
                    <GoogleIcon />
                    Continue with Google
                  </button>

                  <div className="flex items-center gap-3">
                    <div className={`h-px flex-1 ${isLight_ ? "bg-slate-200" : "bg-white/[0.07]"}`} />
